...
const ScheduleDashboard = ({ data }) => {
  ...
  return (
    <div className="flex flex-col gap-6 relative">
      ...
      {showCharts && (
        <>
          <div className="w-full"><ScheduleSidebar data={filteredData} /></div>
          <div className="w-full bg-white p-4 rounded-lg shadow-sm"><ForecastYearBreakdown data={filteredData} /></div>
          <div className="w-full bg-white p-4 rounded-lg shadow-sm"><StagesByClassChart selectedStages={handleStageSelection} /></div>
        </>
      )}
